...
<html>
	...
	<body id="<?php echo $device; ?>" data-page="catalogue">
		<?php include "./assets/navbar.php"; ?>
		<div class="catalogue-items-wrapper noselect">
			...
			<?php
				$items = json_decode(file_get_contents("./source/cfg/default_items.config"), true);
				$image_directory = "./images/default/";
				foreach($items as $item) {
					echo '<div class="catalogue-item-pane"><div class="catalogue-item-image-wrapper" data-title="' . $item["title"] . '"><img class="catalogue-item-image lazyload" src="./images/placeholder.jpg" data-src="' . $image_directory . $item["image"] . '"></div><span class="catalogue-item-title" data-title="' . $item["title"] . '">' . $item["title"] . '</span></div>';
				}
			?>
		</div>
